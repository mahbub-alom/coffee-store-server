...
async function run() {
  try {
    ...
    app.put("/coffee/:id", async (req, res) => {
      ...
      const coffee = {
        $set:{
          name:updatedCoffee.name, quantity:updatedCoffee.quantity, photo:updatedCoffee.photo, supplier:updatedCoffee.supplier, taste:updatedCoffee.taste, category:updatedCoffee.category, details:updatedCoffee.details
        }
      };
